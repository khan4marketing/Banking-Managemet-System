      ...
      <section class="light">
		...
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#">
                <img class="postcard__img" src="images/IUBAT_symbol.jpeg" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
                <h1 class="postcard__title blue"><a href="#">Welcome to IUBAT Bank</a></h1>
				<div class="postcard__bar"></div>
                <div class="postcard__preview-txt"><b>IUBAT Bank</b> is one of the leading commercial banks in Bangladesh. It is a private sector bank and has its headquarters in Dhaka. It serves customers across multiple regional and zonal offices throughout the country.</div>
